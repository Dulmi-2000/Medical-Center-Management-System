...
namespace hospitalDbConnect
{
    public partial class Form1 : Form
    {
        ...
        {
            // to refresh the form when it load after changing the database
...
/*
        ...
        */
        ...
        {
            DoctorPro dd=new DoctorPro();
            addUserControl((UserControl)dd);
        }

        private void guna2Button4_Click(object sender, EventArgs e)
        {
            reciptionPRO pp = new reciptionPRO();
            addUserControl((UserControl)pp);
        }

        private void guna2Button8_Click_1(object sender, EventArgs e)
        {
            ADDdoc aDDdoc = new ADDdoc();
            addUserControl(aDDdoc); 
        }
        ...
        private void textBox23_TextChanged(object sender, EventArgs e)
        {
            ...
            string query = "SELECT COUNT(*) FROM AppointmentsDB WHERE doctor = 'Dr.Kumudu Perera'";
            // Replace 'appointments' with the actual table name
            ...
            SqlCommand command = new SqlCommand(query, con);
                    ...
                    textBox23.Text= appointmentCount.ToString();
        ...
        private void label9_Click(object sender, EventArgs e)
        {
            ...
            string query = "SELECT COUNT(*) FROM AppointmentsDB WHERE DoctorName = 'Dr.Kumudu Perera'";
            // Replace 'appointments' with the actual table name
            ...
            int appointmentCount = (int)command.ExecuteScalar();
            //label9.Text = appointmentCount.ToString();
